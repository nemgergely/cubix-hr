...
public class HrApplication implements CommandLineRunner {
	...
	public void run(String... args) {
		Employee employee1 = new Employee("Vasutas János", "Vasutas", 1000,
			LocalDateTime.of(2010, 5, 10, 10, 0, 0), new Company());
		Employee employee2 = new Employee("Pályamunkás Pál", "Pályamunkás", 1000,
			LocalDateTime.of(2016, 5, 10, 10, 0, 0), new Company());
		Employee employee3 = new Employee("Vonatkerék Vince", "Vonatkerék pumpáló", 1000,
			LocalDateTime.of(2021, 5, 10, 10, 0, 0), new Company());
		Employee employee4 = new Employee("Lakatlan László", "Lakatlan szigeten tömeggyilkos", 1000,
			LocalDateTime.of(2023, 5, 10, 10, 0, 0), new Company());
